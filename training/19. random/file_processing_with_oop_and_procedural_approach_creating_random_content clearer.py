...
# Ask the user if they want to create a new file for the OOP section
new_file_for_oop = input("Enter a new filename for the OOP section or press Enter to use the existing file: ")

# Determine the file path for the OOP section
if new_file_for_oop:
    oop_file_path = os.path.join(current_directory, new_file_for_oop + ".txt")
else:
    oop_file_path = file_path
...
file_handler = FileHandler(oop_file_path)  # Create an instance of FileHandler for the file

# Create and populate the file using the FileHandler object
# This will create a new file if specified or use the existing one
...
# Please check the file '{oop_file_path}' in your current directory for the created and populated content.
